...
import TablesDesign from "./TablesDesign";
          ...
          <tbody>
            {patients
              .filter((cf) => {
                if (
                  ...
                  cf.id.includes(searchById.toLowerCase())
                  // && cf.email.toLowerCase().includes(searchById.toLowerCase())
                ) {
                  return cf;
                }
              })
            ...
            .map((patient) => (
                <tr key={patient.id}>
                  ...
                  <td>{giveColorTOStatus(patient.payStatus)}</td>
